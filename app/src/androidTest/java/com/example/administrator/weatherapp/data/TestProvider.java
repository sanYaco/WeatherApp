...
//        Students: Uncomment this test to make sure you've correctly registered the AppProvider.
//     */
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertEquals("Error: AppProvider registered with authority: " + providerInfo.authority +
                            " instead of authority: " + AppContract.CONTENT_AUTHORITY,
                    providerInfo.authority, AppContract.CONTENT_AUTHORITY);
...
//        );
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(WeatherEntry.COLUMN_CITY_KEY, locationRowId);
            weatherValues.put(AppContract.WeatherEntry.COLUMN_DEGREES, 1.1);
            weatherValues.put(AppContract.WeatherEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * (float) i);
            weatherValues.put(AppContract.WeatherEntry.COLUMN_PRESSURE, 1.3 - 0.01 * (float) i);
            weatherValues.put(AppContract.WeatherEntry.COLUMN_TEMP, 75 + i);
            weatherValues.put(AppContract.WeatherEntry.COLUMN_SHORT_DESC, "HAsteroids");
            weatherValues.put(AppContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float) i);
